// Create a "supprimer" button and append it to each list item
...
// Click on a supprimer button to hide the current list item
...
// Add a "verifier" symbol when clicking on a list item
var list = document.querySelector('ul');
list.addEventListener('click', function(ev) {
  if (ev.target.tagName === 'LI') {
    ev.target.classList.toggle('verifier');
  }
}, false);
...
function newElement() {
  ...
  li.appendChild(t);
  if (inputValue === '') {
    alert("Tu dois ecrir quelque chose !!!");
  } else {
